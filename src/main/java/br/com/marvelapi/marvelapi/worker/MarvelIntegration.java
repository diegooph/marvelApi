...
public class MarvelIntegration {
    ...
    public Character pullIntegrationOnline(String characterCustomId) throws IOException {
        try {
            String characterJson = null;
            characterJson = findCharacterByCustomId(characterCustomId);
            ...
            Character byCustomId = characterDao.findByCustomId(characterCustomId);
            character = characterApiMarvelDto.get(0).

                    convertDtoToEntity();
            // todo: Fazer comparação para ver se mudou algo
            if (byCustomId != null) {
                character.setCharacterId(byCustomId.getCharacterId());
            }
            ...
            if (returnComicsApiMarvel.getData() != null)
                comicsJsonData = returnComicsApiMarvel.getData().
            ...
            if (returnEventsApiMarvel.getData() != null)
                eventJsonData = returnEventsApiMarvel.getData().
            ...
            if (returnSeriesApiMarvel.getData() != null)
                seriesJsonData = returnSeriesApiMarvel.getData().
            ...
            if (returnStoriesApiMarvel.getData() != null)
                storiesJsonData = returnStoriesApiMarvel.getData().
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Verifique sua conexão com a internet");
        }
    }
